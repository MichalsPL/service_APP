<?php
    ...
    class RegistrationController extends Controller {
        ...
        /**
         * Receive the confirmation token from user email provider, login the user. Automatic user login is disabled as it is not needed in this project
         *
         * @param Request $request
         * @param string  $token
         *
        ...
        public function confirmedAction() {
            ...
            $addedUserRolesArray = $em->createQueryBuilder()
                    ->select('u')
                    ->from('ServiceBundle:User', 'u')
                    ->orderBy('u.id', 'DESC')
                    ->setMaxResults(1)
                    ->getQuery()
                    ->getOneOrNullResult()
